        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-6">
              ...
              <h5 class="bottom-hero-content">Supporting the Government's NIPUN Mission for FLN Today, Not Tomorrow</h5>              
            ...
            <div class="col-md-6">
              <div class="hero-side">
                <div class="hero-item">
                  <img src="images/partners/hero-04.jpg" alt="" class="img-fluid">
                </div>
                <div class="hero-item">
                  <img src="images/partners/hero-01.jpg" alt="" class="img-fluid">
                </div>
                <div class="hero-item">
                  <img src="images/partners/hero-02.jpg" alt="" class="img-fluid">
                </div>
                <div class="hero-item">
                  <img src="images/partners/hero-03.jpg" alt="" class="img-fluid">
                </div>
              </div>
            </div>
          </div>
            ...
            <ul class="nav nav-pills mb-3 justify-content-center" id="pills-tab" role="tablist">
              <li class="nav-item" role="presentation">
                <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true">
                  <span class="sup-day">Day 1</span>WEDNESDAY<span class="com">,</span><br> 10 January 2024
                </button>
             </li>
              <li class="nav-item" role="presentation">
                <button class="nav-link" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile" aria-selected="false">
                  <span class="sup-day">Day 2</span>THURSDAY<span class="com">,</span><br> 11 January 2024
                </button>
              </li>
              <li class="nav-item" role="presentation">
                <button class="nav-link" id="pills-contact-tab" data-bs-toggle="pill" data-bs-target="#pills-contact" type="button" role="tab" aria-controls="pills-contact" aria-selected="false">
                  <span class="sup-day">Day 3</span>FRIDAY<span class="com">,</span><br> 12 January 2024
                </button>
              </li>
            </ul>
